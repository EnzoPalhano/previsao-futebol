...
def _por_nome() -> dict[str, validacao.Medida]:
...
def test_a_grade_de_xi_cobre_todos_os_valores() -> None:
    tabela = relatorio_fase4._varredura_xi(_por_nome())
...
def test_o_valor_padrao_da_grade_usa_a_medida_do_dixon_coles() -> None:
    ...
    medidas = _por_nome()
    tabela = relatorio_fase4._varredura_xi(medidas)
...
def test_a_grade_de_encolhimento_cobre_todos_os_valores() -> None:
    tabela = relatorio_fase4._varredura_encolhimento(_por_nome())
